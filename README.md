...
##### Note : *There is another repository for [Typescript Discord Template](https://github.com/KatsukeX56/DiscordTS_Template)*
...
```js
{
    "prefix" : "!", // Leave empty if you don't want any (not recommended, if you want every message better modify src/events/messageCreate.js
    "botPresence" : {
